...
const Page = () => {
  ...
  const databasesPriceDisplay: any = databasesPricingData[plan.cloud].find(
    (region) => region.region == plan.region
  );
      ...
      <div className="ml-[16px] mr-[16px]  md:ml-[42px] md:mr-[80px]">
        ...
        <div className="pt-[42px] pb-[42px] border-b-2 border-solid border-gray-700">
          ...
          <p className="text-muted-800 text-base font-normal">
            You have selected cloud as {plan.cloud} and region as{" "}
            {databasesPriceDisplay.region} and cost as{" "}
            {databasesPriceDisplay.cost[plan.currency]}
          </p>
