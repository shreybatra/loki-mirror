  ...
  return (
    <main>
      <div className="ml-[16px] mr-[16px]  md:ml-[42px] md:mr-[80px]">
        <h2 className="text-white text-[20px] font-medium md:font-bold md:text-[24px]">Object Storage</h2>

        <PricingPlans planName={"Free Plan"}>
        <p className="text-[12px] mb-[12px] md:text-[14px] text-muted">
            
        You have selected cloud as {selectedCloud} and region as {storagePriceDisplay.region} and cost as {storagePriceDisplay.cost[selectedCurrency]}
          </p>
        ...
        <p className="text-[12px] md:text-[14px] text-muted">
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Aliquid nemo aperiam minima pariatur quas iste eum est, doloremque, non unde laudantium sunt qui eos? Quae doloribus illo eos expedita doloremque!
        </p>
          <PlanDropdown
