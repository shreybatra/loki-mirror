...
export const GetStarted = () => {
  return (
    <div className="flex flex-col gap-[32px] items-center w-[750px]">
      <div>
        <Image src={InfinityCosmocloud} alt="Infinity Cosmocloud" />
      </div>
      <div className="flex flex-col gap-[16px] items-center">
        <h2 className="text-[44px] font-[700] text-center">Start turning your ideas into reality</h2>
        <h4 className="text-muted  text-[20px] font-[400] text-center">
      ...
      <div className="flex flex-col items-center w-[250px]">
        <button className="button-gradient text-[16px] px-[24px] py-[16px] w-full">Let’s get started</button>
