...
export const About = () => {
  return (
    <div className='about-main pl-[20px] pb-[30px] mt-[45px] border-l-[1px] md:border-l-[0px] border-dashed border-primary flex flex-col gap-[80px] w-full relative max-w-[768px]'>
      {
