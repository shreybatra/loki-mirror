    ...
    <div className="flex justify-center w-full px-[10px] py-[6px] md:py-[24px]">
      <div className="navbar flex justify-between items-center w-full md:w-[90%] px-[6px] py-[12px] md:px-[24px] md:py-[12px]">
        ...
        <div className="hidden navigation md:flex md:gap-4 lg:gap-10 items-center">
          <Link href={"/aboutUs"}>
              <div className="text-muted cursor-pointer hover:text-white md:text-sm lg:text-base">About</div>
          </Link>
          ...
          <button className="button-gradient md:text-sm lg:text-base md:px-[12px] md:py-[5px] lg:px-[24px] lg:py-[10px]" onClick={()=>window.location.href = "https://dashboard.cosmocloud.io/sign-in"}>Login</button>
        </div>
      </div>
    </div>
  );
