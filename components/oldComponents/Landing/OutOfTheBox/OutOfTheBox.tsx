      ...
      <div className="flex flex-col gap-[16px] md:gap-[42px]">
        <div className="flex flex-col w-full gap-[12px]">
          <h3 className="text-[16px] font-[700]">
            Sneak peak into Cosmocloud Build
          </h3>
          <h2
        ...
        <div className="flex flex-col gap-[4px] text-muted text-[18px]">
          <p className="mb-4">
            Cosmocloud Build is a developer platform, which lets your developers
            build APIs in just few minutes. All the way from Scratch to
